...
def main():
    ...
    print("Creating sampler video...")
    sampler_video = create_sampler(input_dir, output_dir, 60, max_videos, segment_duration, filter_string, log_file, score_threshold)
    
    if sampler_video:
        print("Sampling frames from sampler video...")
